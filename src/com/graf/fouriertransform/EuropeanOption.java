...
public class EuropeanOption extends AbstractProductFourierTransform {
	 ...
	 */
	public EuropeanOption(double maturity, double strike, double riskFreeRate) {
		super();
	...
	public double getValue(ProcessCharacteristicFunctionInterface model) {
		...
		return Math.exp(-riskFreeRate*maturity) * integrator.integrate(integrand) / 2.0 / Math.PI;
	}
