 ...
 */
public interface AbstractModelInterfaceBates {
	...
	//new jump component
	RandomVariableInterface getJumpComponent(int timeIndex, RandomVariableInterface[] realizationAtTimeIndex);
	
	void setProcess(AbstractProcessInterfaceBates process);
	 ...
	 * @return the process
	 */
	AbstractProcessInterfaceBates getProcess();
	 ...
	 */
	AbstractModelInterfaceBates getCloneWithModifiedData(Map<String, Object> dataModified) throws CalculationException;
}