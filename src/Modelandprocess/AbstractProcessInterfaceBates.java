 ...
 */
public interface AbstractProcessInterfaceBates extends ProcessInterface {
	 ...
	 */
	void setModel(AbstractModelInterfaceBates model);
	 ...
	 */
	AbstractProcessInterfaceBates getCloneWithModifiedData(Map<String, Object> dataModified);
	 ...
	 */
	AbstractProcessInterfaceBates clone();
}